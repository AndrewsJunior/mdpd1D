...
%%% method(gradient descent and newton (ddiv_estimator3))  with robust                          %%%
%%% warmstarts for uncontaminated data.                                                         %%%
...
A = [y; h; s; h1; s1];
fileID = fopen('runtimeuncontaminatedRobust.txt','w');
...
save('runtimetableuncontaminatedRobust.mat','gd_mean_rt','gd_ste_rt','nm_mean_rt', 'nm_ste_rt', 'y');